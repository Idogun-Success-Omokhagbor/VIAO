...
export default function SavedEventsPage() {
  ...
  useEffect(() => {
    void (async () => {
      ...
      setError(null)
      try {
        const res = await fetch("/api/events/me/saved", { cache: "no-store", credentials: "include" })
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        {isLoading && <div className="flex items-center justify-center py-12 text-gray-600">Loading saved events...</div>}
          ...
          <>
            ...
            {events.length === 0 && (
              <div className="text-center py-12">
                <h3 className="text-lg font-semibold text-gray-600 mb-2">No saved events</h3>
                <p className="text-gray-500">Save events to find them here later.</p>
              </div>
            )}
          </>
        )}
